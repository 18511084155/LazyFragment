...
import com.woodys.lazyfragment.LazyFragment;
...
public class MoreFragment extends LazyFragment {
    ...
    @Override
    protected View onCreateLazyoadingView() {
        return LayoutInflater.from(getApplicationContext()).inflate(R.layout.fragment_lazy_loading, null,false);
    }
