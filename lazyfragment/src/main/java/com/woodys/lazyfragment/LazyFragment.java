...
public abstract class LazyFragment extends BaseFragment {
    ...
    public final void onStart() {
        if (DEBUG) Log.d(TAG, "onStart() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onStart();
    ...
    public final void onStop() {
        super.onStop();
        if (DEBUG) Log.d(TAG, "onStop() called: " + "getUserVisibleHint():" + getUserVisibleHint());
        if (isInit && isStart && getUserVisibleHint()) {
            isStart = false;
            onFragmentStopLazy();
        }
    ...
    public final void onResume() {
        if (DEBUG) Log.d(TAG, "onResume() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onResume();
        if (isInit) {
            onResumeLazy();
        }
    ...
    public final void onPause() {
        if (DEBUG) Log.d(TAG, "onPause() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onPause();
        if (isInit) {
            onPauseLazy();
        }
    ...
    public final void onDestroyView() {
        if (DEBUG) Log.d(TAG, "onDestroyView() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onDestroyView();
        if (isInit) {
            onDestroyViewLazy();
        }
