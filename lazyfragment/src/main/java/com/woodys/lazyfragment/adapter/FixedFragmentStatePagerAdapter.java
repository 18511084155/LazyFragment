package com.woodys.lazyfragment.adapter;
...
public abstract class FixedFragmentStatePagerAdapter extends PagerAdapter {
    private static final String TAG = FixedFragmentStatePagerAdapter.class.getSimpleName();
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG) Log.v(TAG, "Removing item #" + position + ": f=" + object + " v=" + ((Fragment)object).getView() + " t=" + fragment.getTag());
